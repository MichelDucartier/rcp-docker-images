...
runai submit \
  ...
  --interactive \
  --image registry.rcp.epfl.ch/claire/moalla/transformers-in-rcp:dev-latest-moalla \
  --pvc runai-claire-moalla-scratch:/claire-rcp-scratch \
  -e PROJECT_ROOT_AT=/claire-rcp-scratch/home/moalla/transformers-in-rcp/dev \
  -e SSH_SERVER=1 \
